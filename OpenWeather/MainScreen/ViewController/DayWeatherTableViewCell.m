...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [self.dayNameLabel.leftAnchor constraintEqualToAnchor:self.contentView.leftAnchor constant:15].active = true;
        ...
        [self.weatherImage.leftAnchor constraintEqualToAnchor:self.dayNameLabel.rightAnchor constant:-15].active = true;
        ...
        [self.maxTemperatureLabel.rightAnchor constraintEqualToAnchor:self.contentView.rightAnchor constant:-15].active = true;
        ...
        [self.minTemperatureLabel.rightAnchor constraintEqualToAnchor:self.maxTemperatureLabel.leftAnchor constant:-15].active = true;
